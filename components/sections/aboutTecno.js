...
const AboutTecno = () => {
  ...
  return (
    <div className="w-screen min-h-screen md:p-12 bg-transparent flex text-white items-end justify-center flex-col text-2xl md:text-[2.6rem] font-thin">
      <div className="font-babaPro py-2 w-screen text-center md:text-right md:mx-8">
        <span className="border-b">ABOUT Tecno</span>
      </div>
      <div className="flex md:flex-row flex-nowrap flex-col">
        <div
          className="hidden md:block"
          style={{ transform: `translateY(-${(offsetY - 600) * 0.3}px)` }}
        >
          <Image src={back} className="object-scale-down" />
        </div>
