...
const Hero = ({ showMenu }) => {
  ...
  return (
    <div className="absolute top-0 h-screen w-screen m-0 bg-black">
      ...
      <div className="relative h-[15vh] md:h-[47vh] lg:h-[50vh] w-screen md:w-[80vw] m-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <video
          autoPlay
          muted
          loop
          className="h-[15vh] md:h-[47vh] lg:h-[50vh] w-screen md:w-[80vw] object-cover"
        >
